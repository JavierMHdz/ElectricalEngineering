...
{
 public:
  // Constructs a solved board of given dimension (i.e. size = dim*dim)
  Board(int dim); 

  // Init a board of given dimension and scramble it with numInitMoves 
  ...
  int getSize() const;
  // returns the dimension of a side of the board
  int getDim() const;
